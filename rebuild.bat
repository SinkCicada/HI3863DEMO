...
set "BAD_DIR=%OUT_DIR%\obj\foundation\distributedschedule\samgr_lite\config\system_capability.json"
set "PYTHONHOME="
...
if exist "%BAD_DIR%\system_capability.json" rmdir /S /Q "%BAD_DIR%"
