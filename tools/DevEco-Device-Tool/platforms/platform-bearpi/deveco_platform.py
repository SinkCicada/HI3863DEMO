...
class BearpiPlatform(PlatformBase):
    ...
    def configure_default_packages(self, options, targets):
        ...
        build_packages = {
            "ck804ef": {"hpm": ["gn", "ninja", "llvm"],
                        "hb": ["gn", "ninja", "llvm"],
                        "ohos-sources": ["gn", "ninja", "llvm"]}
        }
        
        clean_packages = {
            "cortex-a7": {"hb": ["gn"], "ohos-sources": [], "hpm": []}
        }
    ...
    def tasks(self, board_id, project, env):
        ...
        # Regular operations
        if "linux" in get_systype() and board_id in ['bearpi_hm_micro']:
