...
if upload_protocol == 'bflb_eflash_loader':
    env.SConscript("bflb_eflash_loader.py", exports="env")
    upload_actions = [env.VerboseAction(env.BflbEflashLoaderUpload, "Uploading with bflb_eflash_loader")]
