...
var actions = {
  ...
  search: function search(args) {
    var _require10 = require("".concat(commandsPath, "/search")),
        searchAction = _require10.search;

    return searchAction.apply(void 0, _toConsumableArray(args));
  },
  update: function update(args) {
    var _require11 = require("".concat(commandsPath, "/update")),
        updateAction = _require11.update;

    return updateAction.apply(void 0, _toConsumableArray(args));
  },
  'check-update': function checkUpdate(args) {
    var _require12 = require("".concat(commandsPath, "/checkUpdate")),
        checkUpdateAction = _require12.checkUpdate;

    return checkUpdateAction.apply(void 0, _toConsumableArray(args));
  },
  list: function list(args) {
    var _require13 = require("".concat(commandsPath, "/list")),
        listAction = _require13.list;

    return listAction.apply(void 0, _toConsumableArray(args));
  },
  'gen-keys': function genKeys(args) {
    var _require14 = require("".concat(commandsPath, "/generateKeys")),
        generateKeys = _require14.generateKeys;

    return generateKeys.apply(void 0, _toConsumableArray(args));
  },
  extract: function extract(args) {
    var _require15 = require("".concat(commandsPath, "/extract")),
        extractAction = _require15.extract;

    return extractAction.apply(void 0, _toConsumableArray(args));
  },
  lang: function lang(args) {
    var _require16 = require("".concat(commandsPath, "/lang")),
        langAction = _require16.lang;

    return langAction.apply(void 0, _toConsumableArray(args));
  },
  code: function code(args) {
    var _require17 = require("".concat(commandsPath, "/code")),
        codeAction = _require17.code;

    return codeAction.apply(void 0, _toConsumableArray(args));
  },
  download: function download(args) {
    var _require18 = require("".concat(commandsPath, "/download")),
        downloadsAction = _require18.downloads;

    return downloadsAction.apply(void 0, _toConsumableArray(args));
  },
  fetch: function fetch(args) {
    var _require19 = require("".concat(commandsPath, "/fetch")),
        fetchAction = _require19.fetch;
...
var actionsWithPluginApi = {
  ui: function ui(pluginAPI, args) {
    var _require20 = require("".concat(commandsPath, "/ui")),
        uiAction = _require20.ui;
...
function _runAction() {
  _runAction = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, args, pluginAPI) {
    var action, _action;
...
exports.defaultCmdConfigs = defaultCmdConfigs;