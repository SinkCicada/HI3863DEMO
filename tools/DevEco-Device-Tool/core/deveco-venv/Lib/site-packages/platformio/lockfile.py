...
class LockFile(object):
    def __init__(self, path, timeout=LOCKFILE_TIMEOUT, delay=LOCKFILE_DELAY):
        ...
        self.delay = delay
        self._lock_path = os.path.join(get_config_json_path(), os.path.split(path)[1]) + '.lock'
        self._fp = None
    ...
    def _lock(self):
        ...
        self._fp = os.fdopen(os.open(self._lock_path, flags, 0o640), 'w')
        try:
    ...
    def release(self):
        ...
        if os.path.exists(self._lock_path):
            try:
                os.remove(self._lock_path)
            except OSError:  # pylint: disable=W0703
                pass
