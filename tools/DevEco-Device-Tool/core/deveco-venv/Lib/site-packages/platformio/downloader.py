...
class FileDownloader(object):
    ...
    def start_handle(self, with_progress, silent, itercontent, para_list):
        label = para_list[0]
        f = para_list[1]
    ...
    def start(self, with_progress=True, silent=False):
        ...
        f = os.fdopen(os.open(self._destination, flags, 0o640), "wb")
        try:
            para_list = [label, f]
            self.start_handle(with_progress, silent, itercontent, para_list)
        finally:
            f.close()
            self._request.close()
